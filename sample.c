...
void* handle_clnt(void* arg){           // arg: (void*)&clnt_sock
    ...
    pthread_mutex_lock(&mutx);          // 뮤텍스 LOCK: 다른 쓰레드가 자원에 접근X
    if (clnt_cnt == 1){
        // sprintf(name, "%d부산.csv", clnt_cnt);
        sprintf(name, "%d부산22.csv", clnt_cnt);
        fname = fopen(name, "w");
        if (fname == NULL){
            printf("파일오픈 실패! \n");
            return -1;
        ...
        // sprintf(name, "%d충북.csv", clnt_cnt);
        sprintf(name, "%d충북22.csv", clnt_cnt);
        fname = fopen(name, "w");
        if (fname == NULL){
            printf("파일오픈 실패! \n");
            return -1;
        ...
        // sprintf(name, "%d대구.csv", clnt_cnt);
        sprintf(name, "%d대구22.csv", clnt_cnt);
        fname = fopen(name, "w");
        if (fname == NULL){
            printf("파일오픈 실패! \n");
            return -1;
...
//     int str_len = 0, i;                 // 클라이언트로부터 수신한 메시지의 길이를 저장
//     char msg[BUF_SIZE];                 // 클라이언트로부터 수신한 메시지를 저장할 문자열 배열
//     char msg2[BUF_SIZE];                // 클라이언트로부터 수신한 메시지를 저장할 문자열 배열
//     char name[10], name2[10];           // 파일 이름 받기
//     char three[5] = "2013";
//     char four[5] = "2014";
//     FILE* fname;
...
//     // // 2013일 때
//     // sprintf(name, "%d_2013.csv", clnt_cnt);
//     // FILE* fname = fopen(name, "w");     // 2013

//     // // 2014일 때
//     // sprintf(name, "%d_2014.csv", clnt_cnt);
//     // FILE* fname2 = fopen(name, "w");    // 2014
...
//     while((str_len = read(clnt_sock, msg, sizeof(msg))) != 0){            // 파일의 끝에 도달한 경우 0이 아닌 값 반환
//         msg[str_len] = '\0';    // 메시지의 크기만큼의 배열 마지막 널로 초기화
//         if (strstr(msg, three))
//         {
//             sprintf(name, "%d_2013.csv", clnt_cnt);
//             fname = fopen(name, "w");
...
//         }            
//         else{
//             sprintf(name2, "%d_2014.csv", clnt_cnt);
//             fname2 = fopen(name2, "w");
//             fputs(msg2, fname2);
//             printf("%s", msg2);
//         }
//         // else if (clnt_cnt == 2)      // 충북
//         // {   
//         //     fputs(msg, fname);
//         //     printf("%s", msg);
//         // }   
//         // else if (clnt_cnt == 3)      // 대구
//         // {   
//         //     fputs(msg, fname);
//         //     printf("%s", msg);
//         // }   
//         // else if (clnt_cnt == 4)      // 대전
//         // {   
//         //     fputs(msg, fname);
//         //     printf("%s", msg);
//         // }   
//         // else if (clnt_cnt == 5)      // 강원
//         // {   
//         //     fputs(msg, fname);
//         //     printf("%s", msg);
//         // }   
//         // else if (clnt_cnt == 6)      // 광주
//         // {   
//         //     fputs(msg, fname);
//         //     printf("%s", msg);
//         // }   
//         // else if (clnt_cnt == 7)      // 경기
//         // {   
//         //     fputs(msg, fname);
//         //     printf("%s", msg);
//         // }   
//         // else if (clnt_cnt == 8)      // 제주
//         // {   
//         //     fputs(msg, fname);
//         //     printf("%s", msg);
//         // }   
//         // else if (clnt_cnt == 9)      // 전주
//         // {   
//         //     fputs(msg, fname);
//         //     printf("%s", msg);
//         // }   
//         // else if (clnt_cnt == 10)      // 서울
//         // {   
//         //     fputs(msg, fname);
//         //     printf("%s", msg);
//         // }
